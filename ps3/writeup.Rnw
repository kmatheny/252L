...
As we are dealing with a Rasch model, the maximum information will be at the average of the difficulties of the items in the test. In our case, the maximum is at 0.167.
